            ...
            <div>
                <div className="user-details__title_container">
                    <div className="user-details__block-column">
                        ...
                        <h2 className="user-details__subtitle">{currentUser.user_location}</h2>
                    </div>
                </div>
                <div className="user-details__title_container">
                    <div className="user-details__block-row">
                        ...
                        <button className="user-details__button"><img className="event-details__icon-flag"/>
                ...
                <div className="user-details__block-column">
                    ...
                    <div
                        ...
                        <p className="user-details__content">{currentUser.user_description}</p>
                        <div className="user-details__subtitle_container">
