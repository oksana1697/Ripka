      ...
      <div className={b()}>
        ...
        <div className={b("header")}>
          <div className={b("header_container")}>
            ...
            <div className={b("options")}>
              <button className={b("options_button")}>Bookmark</button>
              <button className={b("options_button")}>Report</button>
            </div>
          </div>
        </div>
        <div className={b("details")}>
          ...
          <div className={b("details_right")}>
            <img className={b("photo")} src={CLOUDINARY_URL + "c_fill,q_90/" + event.photo + ".jpg"} alt={"name"} />
            <div>
